...
void EagerSearch::initialize() {
    log << "Conducting best first search"  // TODO: Where does stop on solution happen?
...
SearchStatus EagerSearch::expand(const SearchNode &node) {
    ...
    if (check_goal_and_set_plan(state))  
        return IN_PROGRESS;//SOLVED; // TODO: If continue_on_solve, return IN_PROGRESS and generate_successors
